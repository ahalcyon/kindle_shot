...
| `--min-free-gb` | 5 | 出力先の空きがこれを下回ったら**本の切れ目で**バッチを中断する（0 で無効） |
...
- **終了コード**:
  ...
  | 9 | `batch` で出力先の空き容量が下限を割ったため中断した。空きを作れば続きから再開できる |
